...
Additional tools are available in the tools directory. The NCL scripts that plot spatial maps are configured to recognise RegCM and REMO model data, as well as any data used in the analysis of Giorgi & Ciarlo (2022) and Belleri et al. (2023).
